          ...
          <div className="relative w-full max-w-5xl">
            ...
            <div className="flex justify-center">
              <div className="relative flex flex-col items-center">
                ...
                <div className="-mt-8 mb-2 text-2xl lg:text-4xl font-semibold text-nexo-orange-500 text-center z-10 relative">
                  ¿Qué esperar de nosotros?
                </div>
                <ArrowDown className="h-6 w-6 text-nexo-orange-500 mx-auto mt-2" />
              </div>
            </div>
